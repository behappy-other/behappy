package org.xiaowu.behappy.common.es.config.util;
...
public class EsUtils {
    ...
    static {
        restHighLevelClient = SpringUtil.getBean("restHighLevelClient");
    }
    ...
    public static boolean indexExists(String indexName) throws Exception {
        ...
        boolean exists = EsUtils.restHighLevelClient.indices().exists(getIndexRequest, RequestOptions.DEFAULT);
        return exists;
    }
    ...
    public static boolean delData(String indexName, BoolQueryBuilder boolQueryBuilder) throws Exception {
        try {
            ...
            BulkByScrollResponse resp = EsUtils.restHighLevelClient.deleteByQuery(request, RequestOptions.DEFAULT);
        } catch (IOException e) {
            return false;
        }
        return true;
    ...
    public static boolean addData(String indexName, List list) throws Exception {
        ...
        if (CollUtil.isNotEmpty(list)) {
            ...
            BulkResponse bulkResponse = EsUtils.restHighLevelClient.bulk(bulkRequest, RequestOptions.DEFAULT);
            //是否失败 ,返回false 代表成功
    ...
    private static Map<String, Object> manageResult(SearchRequest searchRequest) throws IOException {
        ...
        SearchResponse searchResponse = EsUtils.restHighLevelClient.search(searchRequest, RequestOptions.DEFAULT);
    ...
    private static boolean clearScroll(String scrollId) throws IOException {
        ...
        ClearScrollResponse clearScrollResponse = EsUtils.restHighLevelClient.clearScroll(clearScrollRequest, RequestOptions.DEFAULT);
    ...
    public static List<Map> getEsData(String indexName, BoolQueryBuilder boolQuery) throws Exception {
        ...
        while (searchHits != null && searchHits.length > 0) {
            ...
            searchResponse = EsUtils.restHighLevelClient.scroll(scrollRequest, RequestOptions.DEFAULT);
