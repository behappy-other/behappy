...
import static org.xiaowu.behappy.thirdparty.enums.BizCode.SMS_SEND_FAIL;
...
public class SmsService {
    ...
    public void sendSms(SendSmsDto sendSmsDto) {
        ...
        request.setPhoneNumbers(sendSmsDto.getMobile());
        //必填:短信签名-可在短信控制台中找到
        ...
        request.setTemplateParam("{\"code\":" + sendSmsDto.getCode() + "}");
        ...
        if (sendSmsResponse.getCode() == null && !sendSmsResponse.getCode().equals("OK")) {
            //请求失败
            throw new BeHappyException(SMS_SEND_FAIL.getCode(), SMS_SEND_FAIL.getMsg());
        }
    }
